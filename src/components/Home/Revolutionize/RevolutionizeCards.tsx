  ...
  return (
    <div className="mt-[40px] lg:mt-[60px] flex flex-col md:flex-row gap-[20px] xl:justify-center flex-wrap">
      {cards.map((card, index) => (
        <div
          key={index}
          className="w-full sm:w-[300px] lg:w-[400px] h-[358px] lg:h-[459px] md:h-[380px] p-[12px] pb-[14px] lg:p-[14px] lg:pb-[50px] rounded-[20px] md:rounded-[50px] bg-[rgba(70,111,255,0.05)]"
        >
